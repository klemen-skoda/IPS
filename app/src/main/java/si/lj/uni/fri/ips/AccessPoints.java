...
public final class AccessPoints {
    ...
    private static final AccessPoint ACCESS_POINT_D = new AccessPoint("c8:b3:73:31:d2:0d", 4, 5, 0); // Swireless
    private static final AccessPoint ACCESS_POINT_E = new AccessPoint("dc:fe:07:1b:34:86", 0, 0, 3); // 270072
    private static final AccessPoint ACCESS_POINT_F = new AccessPoint("00:0e:2e:40:87:fd", 6, 0, 3); // default jaht
    ...
    public static List<AccessPoint> getAccessPoints() {
        return Arrays.asList(new AccessPoint[]{ACCESS_POINT_A, ACCESS_POINT_B, ACCESS_POINT_C, ACCESS_POINT_D ,ACCESS_POINT_E, ACCESS_POINT_F});
    }
}